--[[
	...
	Wall Hack Module [Floninja] by Parkourdog2077 © CC0 1.0 Universal (2023)
...
if not getgenv().Floninja or getgenv().Floninja.WallHack then return end
...
local Environment = getgenv().Floninja.WallHack
