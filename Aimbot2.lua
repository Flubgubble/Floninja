--[[
	...
	Aimbot Module [Floninja] by Parkourdog2077 © CC0 1.0 Universal (2024)
...
if not getgenv().Floninja or getgenv().Floninja.Aimbot then return end
...
function Environment.Functions:Exit()
	...
	getgenv().Floninja.Aimbot.Functions = nil
	getgenv().Floninja.Aimbot = nil
